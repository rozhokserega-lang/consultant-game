...
- [x] Debug API: `window.__sale` / `window.__game` (`warp`, `god`, `spawn`, `levelup`, `gold`, `count`)
- [ ] Дев-панель в UI (тап по версии)
- [ ] Уникальные босс-механики ТЦ (не только director/admin)
