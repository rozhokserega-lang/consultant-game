...
const EXTRACT_VERSION = '0.3.5-no-hub-atlas';
...
/** Размер этажа вылазки (крупные комнаты). */
const EXTRACT_RAID_W = 2400;
const EXTRACT_RAID_H = 1800;

/** Маша платит долю от value лута. */
const EXTRACT_SELL_RATE = 1;
