...
const SALE_TREE_PERKS = [
  ...
  { id: 'double_shift', branch: 'tempo', ico: '⏱️', name: 'Двойная смена', desc: '+1 слот оружия, −50 max HP', cost: 220, keystone: true, bonus: { weaponSlots: 1, hp: -1 } },
  { id: 'vital', branch: 'survival', ico: '🥫', name: 'Запас энергии', desc: '+50 max HP', cost: 0, bonus: { hp: 1 } },
